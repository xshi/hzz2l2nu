...
try: import FWCore.ParameterSet.Config as cms
    ...
    sys.exit()
#import FWCore.Utilities.Exception as cmsexception #didn't work
...
outputSummary=True
hltProcName="HLT3"
#runOpen=False#True #ignore all filter decisions, true for testing

if isData:
    from hlt_Photon135 import *    # module name is chosen by the user and injected here by openHLT.py
else:
...
runProducers=False 
runOpen=True 
#ifiles=['/store/user/xshi/SinglePhoton/SinglePhoton_Run2012B/fe25c1cf989d0c6844ee0d2acac09f98/prod_122_1_1Ll.root'] 
ifiles=['Prod_Photon135_5k.root']
ofile="filt.root" 
maxNrEvents=1000
