  ...
  for (size_t itrig = 0; itrig != triggerBitsH->size(); ++itrig)
    {
      ...
      // if (trigName.find("_PFMET40_v") != std::string::npos)
      // if ( (trigName.find("Photon22") != std::string::npos) ||
      // 	   (trigName.find("PFMET40") != std::string::npos) )
      // 	cout << ">>>----------- Trig name: " << trigName << endl;
      ...
      for(size_t it=0; it<triggerPaths.size(); it++)
	{
	  ...
	  // if ( trigName.find("PFMET40") != std::string::npos)
	  //   cout << ">>> ---------Found Trig name: " << trigName << endl;
